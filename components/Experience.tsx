...
import ExperienceCardtestbook from "./ExperienceCardtestbook";
...
<h3 className="absolute top-28 items-center uppercase tracking-[20px] text-[rgb(30,215,96)] ml-7">Experience</h3>
